  ...
  return (
    <div className="flex items-center gap-2">
      <select
        ...
        className={cn(
          'h-8 px-2.5 pr-7 text-xs bg-white border border-zinc-200 rounded-lg text-zinc-700',
          'focus:outline-none focus:border-zinc-400 transition-colors cursor-pointer appearance-none',
