    ...
    <div className="animate-pulse">
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {[100, 112, 104, 110].map((w, i) => (
          <div key={i} className={`h-8 bg-zinc-100 rounded-lg`} style={{ width: w }} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-8">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="bg-white border border-zinc-100 rounded-xl p-5">
            ...
            <div className="h-8 w-20 bg-zinc-200 rounded mb-1.5" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
        {/* Activity feed */}
        <div className="lg:col-span-7 bg-white border border-zinc-100 rounded-xl overflow-hidden">
            ...
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="px-5 py-3.5 flex items-start gap-3">
                ...
                <div className="flex-1 space-y-1.5">
                  <div className="h-3.5 w-64 bg-zinc-200 rounded" />
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="bg-white border border-zinc-100 rounded-xl overflow-hidden">
            ...
            {[0, 1, 2].map((i) => (
              <div key={i} className="px-4 py-3 flex items-center gap-3 border-b border-zinc-50 last:border-0">
                <div className="w-7 h-7 rounded-full bg-zinc-100 shrink-0" />
          ...
          <div className="bg-white border border-zinc-100 rounded-xl overflow-hidden">
            ...
            {[0, 1, 2].map((i) => (
              <div key={i} className="px-4 py-3 flex items-center gap-3 border-b border-zinc-50 last:border-0">
                ...
                <div className="h-4 w-12 bg-zinc-100 rounded-full shrink-0" />
              </div>
            ))}
          </div>
        </div>
